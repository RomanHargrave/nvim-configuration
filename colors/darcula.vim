...
let fg_standard  = '#A9B7C6'
let fg_alternate = '#BFBFBF'
let bg_standard  = '#1C1C1C'
...
hi CursorLine ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#212121 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#212121 gui=NONE

hi ColorColumn ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#38393b gui=NONE

hi Normal ctermfg=146 ctermbg=235 cterm=NONE guifg=#A9B7C6 guibg=#1C1C1C gui=NONE
hi NonText ctermfg=250 ctermbg=236 cterm=NONE guifg=#8994A1 guibg=#1C1C1C gui=NONE

hi LineNr ctermfg=60 ctermbg=237 cterm=NONE guifg=#8994A1 guibg=#313335 gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#8994A1 guibg=#313335 gui=NONE
...
hi Folded ctermfg=244 ctermbg=235 cterm=NONE guifg=#808080 guibg=#2b2b2b gui=italic
...
hi Conditional ctermfg=173 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi Constant ctermfg=103 ctermbg=NONE cterm=NONE guifg=#9876aa guibg=NONE gui=italic
hi Define ctermfg=173 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi Identifier ctermfg=173 ctermbg=NONE cterm=NONE guifg=#9876AA guibg=NONE gui=NONE
hi Keyword ctermfg=173 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi Operator ctermfg=173 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi StorageClass ctermfg=173 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
